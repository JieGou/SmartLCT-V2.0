    ...
    public class ScreenBrightInfo : SmartLCTViewModeBase
    {
        ...
        public OneSmartBrightEasyConfig SelectedSmartBrightItem
        {
            ...
            set
            {
                ...
                CmdEditTimingAdjustData.RaiseCanExecuteChanged();
                CmdDeleteSelectedTimingAdjustData.RaiseCanExecuteChanged();
            }
        }
        ...
        public ScreenBrightInfo()
        {
            ...
            DisplaySmartBrightCfg.CollectionChanged += (s, e) => 
            {
                switch (e.Action)
                {
                    ...
                    case System.Collections.Specialized.NotifyCollectionChangedAction.Reset:
                        CmdClearTimingAdjustData.RaiseCanExecuteChanged();
                        break;
                    default:
                        break;
                }
